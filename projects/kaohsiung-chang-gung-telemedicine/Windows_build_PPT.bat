...
rem Build the deck from any working directory. All paths are based on this BAT file.
set "PROJECT_DIR=%~dp0"
...
"%VENV_DIR%\Scripts\python.exe" -m pip install --disable-pip-version-check -r "%REPO_ROOT%\requirements.txt"
if errorlevel 1 goto :failed
